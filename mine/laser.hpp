...
public:
   ...
   * @param max_beams number of beams to use     **NOT NEEDED**
   ...
   */
  void SetLaserPose(pf_vector_t & laser_pose);//              **SICURAMENTE DA CAMBIARE COME VIENE DETERMINATA**
 ...
 */
class LaserData                   //                **SICURAMENTE DA MODIFICARE**
{
public:
  Laser * laser;
 ...
 */
class BeamModel : public Laser   //                           **SICURAMENTE DA TOGLIERE O MODIFICARE, CONTROLLA DOVE USATO**
{
public:
  /*
 ...
 */
class LikelihoodFieldModel : public Laser  //                       **DA MODIFICARE**
{
public:
  /*
   * @brief BeamModel constructor
 ...
 */
class LikelihoodFieldModelProb : public Laser//                                                 **DA TOGLIERE O MODIFICARE**
{
public:
  /*
   * @brief BeamModel constructor
